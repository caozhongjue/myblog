package top.caozhongjue.interceptor.config.jwt;
...
public class JwtConfig {
     ...
     */
    private static final long EXPIRE_TIME = 864000;
    ...
    public String createTokenByWxAccount(User user) {
        ...
        String token = JWT.create()
                .withClaim("wxOpenId", user.getAccountId())
    ...
    public boolean verifyToken(String token) {
        try {
            //1 . 根据token解密，解密出jwt-id , 先从nredis中查找出redisToke，匹配是否相同
